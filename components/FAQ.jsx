        ...
        variants={slideIn('left','tween',0.2,1)}
         className="w-[90%] m-auto bgHero2">
          ...
          <div className="flex flex-col gap-10 text-shoot-white 	 " >
            <div>
              <p className='overflow-y-hidden text-lg sm:text-2xl lg:text-4xl font-bold' >- How can we participate  ?</p>
              <p className='text-lg' >You find the link to the registrations on our instagram bio or in pinned post on our facebook page </p>
            </div>

            <div>
              <p className='overflow-y-hidden text-lg sm:text-2xl lg:text-4xl'>- Do i need to have a team before joining ?</p>
            ...
            <div>
              <p className='overflow-y-hidden text-lg sm:text-2xl lg:text-4xl'>- Why join us ?</p>
            ...
            <div>
              <p className='overflow-y-hidden text-lg sm:text-2xl lg:text-4xl'>- Is it free ??</p>
